package ru.mediaserver.clients.msdesktop.presentation.menu.files;
...
import ru.mediaserver.clients.msdesktop.business.files.model.FileType;
import ru.mediaserver.clients.msdesktop.business.files.service.FileService;
import ru.mediaserver.clients.msdesktop.business.files.service.task.DownloadTask;
import ru.mediaserver.clients.msdesktop.business.files.service.task.UploadTask;
import ru.mediaserver.clients.msdesktop.business.files.util.FileUtil;
import ru.mediaserver.clients.msdesktop.business.util.SecurityUtil;
import ru.mediaserver.clients.msdesktop.presentation.control.FileGrid;
import ru.mediaserver.clients.msdesktop.presentation.event.DragFileHandler;
...
public class FilesPresenter implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Timeline timeline = new Timeline(new KeyFrame(
                ...
                ae -> process.setText(FileService.eventBarProperty.get()))
        );
