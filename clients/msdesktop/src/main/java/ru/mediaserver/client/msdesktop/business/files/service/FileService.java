package ru.mediaserver.client.msdesktop.business.files.service;

import javafx.beans.property.SimpleStringProperty;
import javafx.beans.property.StringProperty;
import ru.mediaserver.client.msdesktop.business.files.model.FileProperty;
import ru.mediaserver.client.msdesktop.business.files.model.converter.URLEncoder;
import ru.mediaserver.client.msdesktop.business.files.repository.FileRepository;
import ru.mediaserver.client.msdesktop.business.files.repository.FileRepositoryImpl;
import ru.mediaserver.client.msdesktop.business.files.repository.InMemoryFileRepositoryImpl;
